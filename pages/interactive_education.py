...
from classes.chat import LessonChat

from utils.page_components import (
    add_common_page_elements,
    create_chat,
)
from classes.db import ChatDB
...
#         messages = [{"role":"user","content":[[{"role":"assistant","content":st.session_state["messages"]}]]}]
...
#     db.save_conversation(conn, st.session_state.session_id,  messages_json)
#     st.write("Congratulations on finishing the object oriented lesson")
